...
public interface DriverExceptionService {
	...
	/**
	 * Retrieve {@link DriverExceptionEntity}s that were generated by the given
	 * driver profile.<br>
	 * <br>
	 * The resulting list will be ordered by execution start time.<br>
	 * <br>
	 * This method will limit the amount of {@link DriverExceptionEntity}s
	 * generated to the given amount of data points, possibly averaging out many
	 * results inbetween.<br>
	 * <br>
