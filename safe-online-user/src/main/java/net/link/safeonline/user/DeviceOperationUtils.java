...
public class DeviceOperationUtils {
    ...
    /**
     * Redirects the user webapp to the external device landing page using the SAML browser post protocol. The SAML
     * authentication request is generated by the device operation service associated with this HTPP session.
     * <p>
     * The method requires the <code>DeviceServiceUrl</code> init parameter defined in web.xml pointing to the location
     * of the user web application location the device issuer should return to.
     * </p>
     * <p>
    ...
    public static String redirect(String landingUrl, DeviceOperationType deviceOperation, String device,
        ...
        String serviceUrl = getInitParameter(externalContext, DEVICE_SERVICE_URL_INIT_PARAM);
        ...
        deviceOperationService = EjbUtils.getEJB("SafeOnline/DeviceOperationServiceBean/local",
