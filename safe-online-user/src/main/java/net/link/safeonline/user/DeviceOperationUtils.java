...
public class DeviceOperationUtils {
     ...
     * <p>
     * The method requires the <code>DeviceServiceUrl</code> init parameter defined in web.xml pointing to the location of the user web
     * application location the device issuer should return to.
     * </p>
     * <p>
    ...
    public static String redirect(String landingUrl, DeviceOperationType deviceOperation, String device, String authenticatedDevice,
        ...
        try {
            RequestUtil.sendRequest(encodedLandingUrl, encodedSamlRequestToken, language, null, false, templateResourceName, httpResponse,
                    true);
