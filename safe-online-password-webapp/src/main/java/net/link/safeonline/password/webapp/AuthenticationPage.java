            ...
            add(new Button(LOGIN_BUTTON_ID) {
                ...
                public void onSubmit() {
                    ...
                    try {
                        ...
                        HelpdeskLogger.add(WicketUtil.toServletRequest().getSession(), "Password Device is disabled", LogLevelType.ERROR);
                    } catch (DeviceRegistrationNotFoundException e) {
                        AuthenticationForm.this.error(getLocalizer().getString("errorDeviceRegistrationNotFound", this));
                        HelpdeskLogger.add(WicketUtil.toServletRequest().getSession(), "Password Device not found", LogLevelType.ERROR);
