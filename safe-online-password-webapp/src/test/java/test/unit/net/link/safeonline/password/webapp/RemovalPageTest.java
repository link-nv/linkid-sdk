...
import net.link.safeonline.password.webapp.RemovalPage;
...
public class RemovalPageTest extends TestCase {
    ...
    public void testRemove()
        ...
        // stubs
        this.mockPasswordDeviceService.remove(userId, password);
        ...
        removalForm.setValue(RemovalPage.PASSWORD_FIELD_ID, password);
    ...
    public void testRemovePasswordsIncorrect()
        ...
        this.wicket.assertErrorMessages(new String[] { "errorOldPasswordNotCorrect" });
