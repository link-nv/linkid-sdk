...
public class ServletTestManagerTest {
	...
	public static class TestServlet extends HttpServlet {
		...
		public void init(ServletConfig config) throws ServletException {
			super.init(config);
			Enumeration<String> initParamNamesEnum = config
		...
		protected void doGet(HttpServletRequest request,
			...
			if (null != sessionAttributeName) {
				...
				LOG.debug("setting session attribute: " + sessionAttributeName
						+ " to " + sessionAttributeValue);
		...
		public static void setSessionAttributeWhenInvoked(String name,
				String value) {
	...
	public void testGetSessionAttribute() throws Exception {
		...
		try {
			...
			assertEquals(HttpServletResponse.SC_OK, statusCode);
			assertTrue(TestServlet.isCalled());
			assertEquals("value1", servletTestManager
					.getSessionAttribute("attribute1"));
		} finally {
			servletTestManager.tearDown();
		}
	}
	...
	public void testSetSessionAttribute() throws Exception {
		...
		try {
			...
			assertEquals(HttpServletResponse.SC_OK, statusCode);
			assertTrue(TestServlet.isCalled());
			assertEquals("value1", TestServlet
					.getSessionAttribute("attribute1"));
		} finally {
			servletTestManager.tearDown();
		}
