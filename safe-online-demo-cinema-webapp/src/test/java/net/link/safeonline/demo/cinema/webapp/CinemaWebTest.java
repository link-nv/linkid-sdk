...
public class CinemaWebTest extends AbstractWicketTests {
    ...
    public void testNewTicket() {
        ...
        @SuppressWarnings("unchecked")
        ListView<CinemaTheatreEntity> theatres = (ListView<CinemaTheatreEntity>) wicket
        ...
        @SuppressWarnings("unchecked")
        ListView<List<CinemaSeatEntity>> rows = (ListView<List<CinemaSeatEntity>>) wicket
