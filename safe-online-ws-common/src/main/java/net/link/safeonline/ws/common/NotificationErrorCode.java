...
public enum NotificationErrorCode {
	...
	public static NotificationErrorCode getNotificationErrorCode(
			String errorCode) {
		NotificationErrorCode notificationErrorCode = errorCodeMap
				.get(errorCode);
		if (null == notificationErrorCode) {
			throw new IllegalArgumentException(
					"unknown Notification error code: " + errorCode);
		}
