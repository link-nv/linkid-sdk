...
import net.link.safeonline.device.sdk.manage.servlet.AbstractDeviceManagementExitServlet;
...
/**
 * <h2>{@link DeviceManagementExitServlet}<br>
 ...
 * @author lhunath
 */
public class DeviceManagementExitServlet extends AbstractDeviceManagementExitServlet {

    private static final long serialVersionUID = 1L;
    private static final Log  LOG              = LogFactory.getLog(DeviceManagementExitServlet.class);
