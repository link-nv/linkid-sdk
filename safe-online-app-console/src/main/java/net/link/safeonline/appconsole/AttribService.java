...
public class AttribService extends JPanel implements Observer {
     ...
     * Actions
     */
    private Action              getAttributesAction   = new GetAttributesAction(GET_ATTRIBUTES.getMessage());
    private Action              deleteAttributeAction = new DeleteAttributeAction(DELETE.getMessage());
    private Action              addAttributeAction    = new AddAttributeAction(ADD_ATTRIBUTE.getMessage());
    ...
    protected void editNode(DefaultMutableTreeNode node) {
        ...
        Object value = null;
        while (null == value) {
            newValue = JOptionPane.showInputDialog(this, "New attribute value ?", origValue);
            if (null == newValue)
                return;
    ...
    private Object getValue(DefaultMutableTreeNode node, String newValue) {
        ...
        if (node.getUserObject() instanceof Date) {
            ...
            JOptionPane.showMessageDialog(this, "Invalid input, valid inputs for this Boolean are: true/false");
            return null;
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Invalid input, not a valid integer value");
                return null;
            }
    ...
    private void addMultiValueAttribute(DefaultMutableTreeNode attributeNameNode, Object attributeValues) {
    ...
    private void addCompoundAttribute(DefaultMutableTreeNode attributeNameNode, Object attributeValue) {
    ...
    /*
     * Get complete attribute value's ( single/multi ) from a given attribute name node
     */
    Object getAttributeValue(DefaultMutableTreeNode node) {
        ...
        DefaultMutableTreeNode tempNode = (DefaultMutableTreeNode) node.getChildAt(0);
    ...
    class AttributeTreeModelListener implements TreeModelListener {
        ...
        public void treeNodesChanged(TreeModelEvent e) {
            ...
            if (e.getTreePath().getPathCount() < 3)
                return;
            String userName = (String) ((DefaultMutableTreeNode) e.getPath()[1]).getUserObject();
            String attributeName = (String) ((DefaultMutableTreeNode) e.getPath()[2]).getUserObject();
            Object attributeValue = getAttributeValue(node);

            if (null == attributeValue)
                return;
            setCursor(new Cursor(Cursor.WAIT_CURSOR));
            LOG.info("Attribute value type : " + attributeValue.getClass().toString());

            ServicesUtils.getInstance().setAttributeValue(userName, attributeName, attributeValue);
        }

        public void treeNodesInserted(@SuppressWarnings("unused") TreeModelEvent e) {
        ...
        public void treeStructureChanged(@SuppressWarnings("unused") TreeModelEvent e) {
    ...
    private class AddAttributeAction extends AbstractAction {
        ...
        public void actionPerformed(@SuppressWarnings("unused") ActionEvent evt) {
            ...
            String attributeName = JOptionPane.showInputDialog("Please give the name of the new attribute");
            ...
            setCursor(new Cursor(Cursor.WAIT_CURSOR));
            ServicesUtils.getInstance().createAttribute(user, attributeName, attributeValue);
