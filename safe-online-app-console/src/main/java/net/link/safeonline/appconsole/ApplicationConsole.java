...
public class ApplicationConsole extends JFrame implements Observer {
    ...
    private Action                   createP12Action      = new CreateP12Action(CREATE_P12.getMessage());
    private Action                   extractAction        = new ExtractAction(EXTRACT_CERT.getMessage());
    private Action                   setLocationAction    = new SetLocationAction(SET_LOCATION.getMessage());
    ...
    Action                           viewInboundAction    = new ViewInboundAction(VIEW_INBOUND_SOAP.getMessage());
    Action                           viewOutboundAction   = new ViewOutboundAction(VIEW_OUTBOUND_SOAP.getMessage());
     ...
     * Non-GUI members
     */
    public ApplicationConsoleManager consoleManager       = ApplicationConsoleManager.getInstance();
    ...
    public class ViewInboundAction extends AbstractAction {
        ...
        public void actionPerformed(@SuppressWarnings("unused") ActionEvent evt) {
            ...
            Document inboundSoap = ApplicationConsoleManager.getInstance().getInboundMessage();
    ...
    public class ViewOutboundAction extends AbstractAction {
        ...
        public void actionPerformed(@SuppressWarnings("unused") ActionEvent evt) {
            ...
            Document outboundSoap = ApplicationConsoleManager.getInstance().getOutboundMessage();
