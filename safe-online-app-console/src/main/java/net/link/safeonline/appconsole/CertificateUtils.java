...
public class CertificateUtils {
	...
	public static X509Certificate generateSelfSignedCertificate(
			KeyPair keyPair, String dn) throws InvalidKeyException, IllegalStateException,
			NoSuchAlgorithmException, SignatureException, IOException, CertificateException {
	...
	public static X509Certificate generateSelfSignedCertificate(
			...
			boolean timeStampingPurpose) throws InvalidKeyException, IllegalStateException,
			NoSuchAlgorithmException, SignatureException, IOException, CertificateException {
	...
	public static void extractCertificate(PrivateKeyEntry privateKeyEntry,
		...
		try {
			...
			throw new RuntimeException("error encoding certificate : " + e.getMessage(), e);
		} catch (IOException e) {
			throw new RuntimeException("error writing out certificate : " + e.getMessage(), e);
		}
	}
}
