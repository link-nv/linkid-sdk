...
public class LinkIDWSSecurityUsernameTokenClientHandlerTest {
    ...
    public void setUp()
        ...
        testedInstance = new WSSecurityUsernameTokenHandler( new AbstractWSSecurityUsernameTokenCallback() {
            ...
            public String handle(final String username) {
                ...
                if (username.equals( LinkIDWSSecurityUsernameTokenClientHandlerTest.this.username ))
                    return password;
    ...
    public void handleMessageInvalidIncomingMessage()
        ...
        // Setup data
        MessageFactory messageFactory = MessageFactory.newInstance( SOAPConstants.SOAP_1_1_PROTOCOL );
        InputStream testSoapMessageInputStream = LinkIDWSSecurityServerHandlerTest.class.getResourceAsStream( "/test-ws-security-username-token-invalid-message.xml" );
    ...
    public void handleMessageValidIncomingMessage()
        ...
        // Setup Data
        MessageFactory messageFactory = MessageFactory.newInstance( SOAPConstants.SOAP_1_1_PROTOCOL );
        InputStream testSoapMessageInputStream = LinkIDWSSecurityServerHandlerTest.class.getResourceAsStream( "/test-ws-security-username-token-valid-message.xml" );
        assertNotNull( testSoapMessageInputStream );
