...
public class LinkIDSubjectAttributesUnmarshaller extends AttributeStatementUnmarshaller {

    @Override
    protected void processChildElement(XMLObject parentObject, XMLObject childObject)
            throws UnmarshallingException {

        LinkIDSubjectAttributes subjectAttributes = (LinkIDSubjectAttributes) parentObject;
