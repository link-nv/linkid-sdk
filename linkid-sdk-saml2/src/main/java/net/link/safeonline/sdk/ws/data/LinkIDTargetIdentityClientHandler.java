 ...
 * @author fcorneli
 */
public class LinkIDTargetIdentityClientHandler implements SOAPHandler<SOAPMessageContext> {
    ...
    private void addTargetIdentityHeader(SOAPHeader soapHeader, SOAPMessageContext soapContext)
         ...
         * Add SOAP Header.
         */
        QName targetIdentityName = new QName( LinkIDDataServiceConstants.LIBERTY_SOAP_BINDING_NAMESPACE, "TargetIdentity" );
