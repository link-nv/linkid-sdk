...
public class LinkIDPaymentResponseUnmarshaller extends AttributeStatementUnmarshaller {

    @Override
    protected void processChildElement(XMLObject parentObject, XMLObject childObject)
            throws UnmarshallingException {

        LinkIDPaymentResponse paymentResponse = (LinkIDPaymentResponse) parentObject;
