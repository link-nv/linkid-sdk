 ...
 * @author lhunath
 */
public abstract class LinkIDRequestUtil {
     ...
     */
    public static void sendRequest(String consumerUrl, LinkIDSAMLBinding requestBinding, RequestAbstractType samlRequest, KeyPair signingKeyPair,
        ...
        switch (requestBinding) {
            case HTTP_POST:
                LinkIDPostBindingUtil.sendRequest( samlRequest, signingKeyPair, certificateChain, relayState, postTemplateResource, consumerUrl, response,
                        language );
                break;

            case HTTP_REDIRECT:
                LinkIDRedirectBindingUtil.sendRequest( samlRequest, signingKeyPair, relayState, consumerUrl, response, language );
                break;
        }
    }
    ...
    public static AuthnRequest findAuthnRequest(HttpServletRequest request) {
        ...
        return LinkIDBindingUtil.findSAMLObject( request, AuthnRequest.class );
    }
    ...
    public static LogoutRequest findLogoutRequest(HttpServletRequest request) {
        ...
        return LinkIDBindingUtil.findSAMLObject( request, LogoutRequest.class );
    }
}
