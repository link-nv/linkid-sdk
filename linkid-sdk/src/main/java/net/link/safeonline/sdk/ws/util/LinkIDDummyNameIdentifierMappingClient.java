...
/**
 * <h2>{@link LinkIDDummyNameIdentifierMappingClient}<br>
 ...
 * @author wvdhaute
 */
public class LinkIDDummyNameIdentifierMappingClient implements LinkIDNameIdentifierMappingClient {

    private static String userId;

    public static void setUserId(String userId) {

        LinkIDDummyNameIdentifierMappingClient.userId = userId;
    }
