 ...
 * @author fcorneli
 */
public class LinkIDMessageLoggingHandler implements SOAPHandler<SOAPMessageContext> {

    private static final Logger logger = Logger.get( LinkIDMessageLoggingHandler.class );
    ...
    public static void addNewHandler(BindingProvider bindingProvider) {
        ...
        Handler<SOAPMessageContext> loggingHandler = new LinkIDMessageLoggingHandler();
