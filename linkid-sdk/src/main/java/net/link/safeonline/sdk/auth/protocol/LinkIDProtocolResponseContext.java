...
/**
 * <h2>{@link LinkIDProtocolResponseContext}<br> <sub>[in short].</sub></h2>
 * <p/>
 * <p> <i>08 19, 2010</i> </p>
 *
 * @author lhunath
 */
public class LinkIDProtocolResponseContext extends LinkIDProtocolContext {

    private final LinkIDProtocolRequestContext request;
     ...
     *                         signature.
     */
    public LinkIDProtocolResponseContext(LinkIDProtocolRequestContext request, String id, CertificateChain certificateChain) {
    ...
    public LinkIDProtocolRequestContext getRequest() {
