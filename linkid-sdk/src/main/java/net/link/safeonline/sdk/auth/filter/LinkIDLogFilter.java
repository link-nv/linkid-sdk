 ...
 * @author wvdhaute
 */
public class LinkIDLogFilter implements Filter {

    private static final Logger logger = Logger.get( LinkIDLogFilter.class );
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        sb.append( httpRequest.getMethod() ).append( " " ).append( httpRequest.getProtocol() )
          .append( " " )
        ...
        LinkIDLogManager.getInstance().postLogBuffer( sb );
