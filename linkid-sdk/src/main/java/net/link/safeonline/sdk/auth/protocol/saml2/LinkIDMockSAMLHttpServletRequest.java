...
/**
 * <h2>{@link LinkIDMockSAMLHttpServletRequest}</h2>
 * <p/>
 ...
 * @author lhunath
 */
public class LinkIDMockSAMLHttpServletRequest extends HttpServletRequestWrapper {

    private static final Logger logger = Logger.get( LinkIDMockSAMLHttpServletRequest.class );

    private final Map<String, String> parameters;

    private final StringBuffer requestURL;

    public LinkIDMockSAMLHttpServletRequest(final String queryString, StringBuffer requestURL) {
