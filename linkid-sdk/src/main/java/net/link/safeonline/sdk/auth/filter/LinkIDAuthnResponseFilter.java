 ...
 * @author fcorneli
 */
public class LinkIDAuthnResponseFilter implements Filter {

    private static final Logger logger = Logger.get( LinkIDAuthnResponseFilter.class );
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            LinkIDAuthnProtocolResponseContext authnResponse = LinkIDProtocolManager.findAndValidateAuthnResponse( httpRequest );
