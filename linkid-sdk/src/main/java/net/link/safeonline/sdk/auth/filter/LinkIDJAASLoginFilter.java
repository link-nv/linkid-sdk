 ...
 * @author fcorneli
 */
public class LinkIDJAASLoginFilter implements Filter {

    private static final Logger logger = Logger.get( LinkIDJAASLoginFilter.class );

    private static final String REDIRECTED_SESSION_ATTRIBUTE = LinkIDJAASLoginFilter.class.getName() + ".redirected";

    public static final String JAAS_LOGIN_CONTEXT_SESSION_ATTRIB = LinkIDJAASLoginFilter.class.getName() + ".LOGIN_CONTEXT";
    ...
    private boolean login(HttpServletRequest request, HttpServletResponse response)
        ...
        String userId = LinkIDLoginManager.findUserId( session );
        if (userId == null) {
