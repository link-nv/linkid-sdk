 ...
 * @author fcorneli
 */
public abstract class LinkIDAbstractInjectionServlet extends HttpServlet {

    private static final Logger logger = Logger.get( LinkIDAbstractInjectionServlet.class );
    ...
    protected String getWrapperEndpoint(HttpServletRequest request) {
        ...
        return LinkIDConfigUtils.getApplicationURL();
    }
}
