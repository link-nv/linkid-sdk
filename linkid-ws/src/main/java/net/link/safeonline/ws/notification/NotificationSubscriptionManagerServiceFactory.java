...
package net.link.safeonline.ws.notification;
...
public class NotificationSubscriptionManagerServiceFactory {
    ...
    public static NotificationSubscriptionManagerService newInstance() {
        ...
        NotificationSubscriptionManagerService service = new NotificationSubscriptionManagerService( wsdlUrl, new QName(
                "urn:net:lin-k:safe-online:notification:subscription:manager", "NotificationSubscriptionManagerService" ) );
