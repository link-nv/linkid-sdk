...
public class EjbUtilsTest extends TestCase {
	...
	public void testGetComponentNamesReturnsEmptyMap() throws Exception {
		...
		// operate
		Map<String, TestType> result = EjbUtils.getComponentNames(jndiPrefix,
				TestType.class);
	...
	public void testGetComponentNamesReturnsObject() throws Exception {
		...
		this.jndiTestUtils.bindComponent(jndiPrefix + "/" + objectName,
				testObject);
	...
	public void testGetComponentsIsEmpty() throws Exception {
		...
		// operate
		List<TestType> result = EjbUtils.getComponents(jndiPrefix,
				TestType.class);
