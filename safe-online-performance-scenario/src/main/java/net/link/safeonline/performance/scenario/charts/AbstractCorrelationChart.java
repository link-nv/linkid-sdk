...
public abstract class AbstractCorrelationChart extends AbstractMovingAverageChart {
     ...
     */
    public AbstractCorrelationChart(String title, String rangeAxisName, int period) {

        super(title, rangeAxisName, period);
    }

    /**
     * @return The value of the first dimension of the correlation for the given {@link ScenarioTimingEntity}.
     */
    protected abstract double getCorrelationX(Long startTime);

    /**
     * @return The value of the second dimension of the correlation for the given {@link ScenarioTimingEntity}.
     */
