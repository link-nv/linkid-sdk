...
public class NotificationConsumerServiceBean implements NotificationConsumerService {
    ...
    private void removeDemoBankUser(String userId) {
        ...
        try {
            ...
            try {
                ...
                List<BankAccountEntity> accounts = demoBankEntityManager.createNamedQuery(BankAccountEntity.getByUser).setParameter(
    ...
    private void removeDemoPaymentUser(String userId) {
        ...
        UserEntity user = demoPaymentEntityManager.find(UserEntity.class, userId);
        if (null != user) {
