...
namespace safe_online_sdk_dotnet
{
	...
	public class SessionTrackingClientImpl : SessionTrackingClient
	{
		...
		public SessionTrackingClientImpl(string location, string appPfxPath, string appPfxPassword, string olasCertPath)
		{
			...
			string address = "https://" + location + "/safe-online-ws/session";
			EndpointAddress remoteAddress = new EndpointAddress(address);
					
			this.client = new SessionTrackingPortClient(new OlasBinding(olasCertificate), remoteAddress);
