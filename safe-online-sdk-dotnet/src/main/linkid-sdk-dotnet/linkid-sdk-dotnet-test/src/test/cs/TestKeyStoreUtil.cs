...
namespace safe_online_sdk_dotnet.test.cs
{
	...
	public class TestKeyStoreUtil
	{
		...
		{
			KeyStoreUtil.GetPrivateKeyFromPfx(TestConstants.testPfxPath, TestConstants.testPfxPassword, true);
		}

		[Test]
		public void TestLoadKeyDirect()
		{
			KeyStoreUtil.GetPrivateKeyFromPem(TestConstants.testKeyPath, true);
		}
