...
public class AttributeProviderPK implements Serializable {
	...
	public AttributeProviderPK(ApplicationEntity application,
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(this.applicationName,
				rhs.applicationName).append(this.attributeTypeName,
				rhs.attributeTypeName).isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(this.applicationName).append(
				this.attributeTypeName).toHashCode();
	}

	@Override
	public String toString() {
		return new ToStringBuilder(this).append("application",
				this.applicationName).append("attribute type",
