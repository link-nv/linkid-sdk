...
public class AttributeProviderEntity implements Serializable {
    ...
    public AttributeProviderEntity(ApplicationEntity application, AttributeTypeEntity attributeType) {
    ...
    public interface QueryInterface {
        ...
        int removeAttributeProviders(@QueryParam("attributeType") AttributeTypeEntity attributeType);
    }
}
