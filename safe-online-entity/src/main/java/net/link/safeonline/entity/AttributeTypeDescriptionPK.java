...
public class AttributeTypeDescriptionPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(this.language, rhs.language).append(
				this.attributeType, rhs.attributeType).isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(this.language).append(
				this.attributeType).toHashCode();
	}

	@Override
	public String toString() {
		return new ToStringBuilder(this).append("language", this.language)
