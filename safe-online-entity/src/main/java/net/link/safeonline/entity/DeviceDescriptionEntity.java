...
@NamedQueries( { @NamedQuery(name = QUERY_WHERE_DEVICE, query = "SELECT deviceDesc "
		+ "FROM DeviceDescriptionEntity AS deviceDesc "
...
public class DeviceDescriptionEntity implements Serializable {
	...
	public DeviceDescriptionEntity(DeviceEntity device, String language,
			String description) {
		this.device = device;
	...
	public interface QueryInterface {
		...
		List<DeviceDescriptionEntity> listDescriptions(@QueryParam("device")
		DeviceEntity device);
	}
}
