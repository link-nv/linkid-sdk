...
@NamedQueries( { @NamedQuery(name = QUERY_WHERE_DEVICE_CLASS, query = "SELECT deviceClassDesc "
		+ "FROM DeviceClassDescriptionEntity AS deviceClassDesc "
		+ "WHERE deviceClassDesc.deviceClass = :deviceClass") })
public class DeviceClassDescriptionEntity implements Serializable {
	...
	public DeviceClassDescriptionEntity(DeviceClassEntity deviceClass,
	...
	public String toString() {
		return new ToStringBuilder(this).append("pk", this.pk).append(
