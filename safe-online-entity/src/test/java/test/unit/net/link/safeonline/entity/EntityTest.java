...
public class EntityTest {
    ...
    public void setUp() {
        ...
        try {
            this.entityTestManager.setUp(SubjectEntity.class,
                    ...
                    ApplicationOwnerEntity.class, AttributeTypeEntity.class,
                    AttributeEntity.class, TrustDomainEntity.class,
                    TrustPointEntity.class, SubjectIdentifierEntity.class,
    ...
    public void testAddHistory() throws Exception {
        ...
        HistoryEntity history = new HistoryEntity(when, subject,
                HistoryEventType.LOGIN_SUCCESS);
        ...
        // operate
        HistoryPropertyEntity applicationProperty = new HistoryPropertyEntity(
                resultHistory, "application", "test-app");
        HistoryPropertyEntity attributeProperty = new HistoryPropertyEntity(
                resultHistory, "attribute", "test-attribute");
        resultHistory.getProperties().put(applicationProperty.getName(),
                applicationProperty);
        resultHistory.getProperties().put(attributeProperty.getName(),
                attributeProperty);
        ...
        // verify
        HistoryEntity resultHistory2 = entityManager.find(HistoryEntity.class,
                history.getId());
