...
public class DERSequenceTest extends TestCase {
	...
	public void testDERSequence() throws Exception {
		...
		org.bouncycastle.asn1.DERInteger resultInt1 = (org.bouncycastle.asn1.DERInteger) resultSequence
				.getObjectAt(0);
		org.bouncycastle.asn1.DERInteger resultInt2 = (org.bouncycastle.asn1.DERInteger) resultSequence
				.getObjectAt(1);
