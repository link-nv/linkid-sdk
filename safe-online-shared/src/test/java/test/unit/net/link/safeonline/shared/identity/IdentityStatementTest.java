...
public class IdentityStatementTest extends TestCase {
    ...
    public void testCreateIdentityStatement() throws Exception {
        ...
        ASN1Object asn1IdentityStatement = ASN1Object.fromByteArray(resultIdentityStatement);
        LOG.debug("Identity statement: " + ASN1Dump.dumpAsString(asn1IdentityStatement));
    }
}
