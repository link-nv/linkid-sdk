...
public class IdentityStatement extends AbstractStatement {
    ...
    public IdentityStatement(String sessionId, String user, String operation, IdentityProvider identityProvider, Signer signer) {

        super(signer, new DERIdentityStatement(signer.getCertificate(), sessionId, user, operation, identityProvider.getGivenName(),
