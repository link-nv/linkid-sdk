...
namespace safe_online_sdk_dotnet
{
	...
	/// This is required by the linkID Data Web Service to communicate the linkID user ID.
	/// </summary>
	...
	/// <summary>
	/// Custom TargetIdentity SOAP header. The linkID subject is wrapped in a SAML subject.
	/// </summary>
