...
public class RemovePage extends TemplatePage {
    ...
    public static final String   ENCAPS_LIST_ID   = "encapList";
    ...
    class ListForm extends Form<String> {
        ...
        public ListForm(String id) {
            ...
            add(new ListView<AttributeDO>(ENCAPS_LIST_ID, new PropertyModel<List<AttributeDO>>(RemovePage.this, "encapAttributes")) {
                ...
                protected void populateItem(ListItem<AttributeDO> attributeItem) {
                    ...
                    attributeItem.add(new Label("encap", attribute.getStringValue()));
