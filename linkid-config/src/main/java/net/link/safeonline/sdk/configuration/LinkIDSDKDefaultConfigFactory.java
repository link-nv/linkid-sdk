...
/**
 * <h2>{@link LinkIDSDKDefaultConfigFactory}<br> <sub>[in short].</sub></h2>
 * <p/>
 * <p> <i>09 14, 2010</i> </p>
 *
 * @author lhunath
 */
public class LinkIDSDKDefaultConfigFactory extends DefaultConfigFactory {

    public LinkIDSDKDefaultConfigFactory() {
    ...
    protected String generateValueExtension(@NotNull final Method method) {
        ...
        if ("appPath".equals( method.getName() ) && method.getDeclaringClass().equals( LinkIDWebConfig.class ))
