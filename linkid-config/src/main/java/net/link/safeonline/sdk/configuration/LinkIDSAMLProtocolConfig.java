...
/**
 * <h2>{@link LinkIDSAMLProtocolConfig}<br>
 * <sub>[in short].</sub></h2>
 * <p/>
 * <p>
 * <i>09 16, 2010</i>
 ...
 */
@Group(prefix = "saml")
public interface LinkIDSAMLProtocolConfig {
    ...
    /**
     * SAML2 binding to use when dispatching requests. See {@link LinkIDSAMLBinding} for possible values.
     * <p/>
     * <i>[required, default: HTTP_POST]</i>
     */
    @Property(required = true, unset = "HTTP_POST")
    LinkIDSAMLBinding binding();
