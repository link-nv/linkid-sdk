...
/**
 * Prescription JAAS login module. This login module will retrieve the username
 * and role attribute from the HTTP servlet request using JACC. It uses these
...
public class PrescriptionLoginModule implements LoginModule {
	...
	private static final Log LOG = LogFactory
			.getLog(PrescriptionLoginModule.class);
