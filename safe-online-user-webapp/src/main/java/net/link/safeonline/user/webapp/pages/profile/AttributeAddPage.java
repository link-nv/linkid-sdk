...
public class AttributeAddPage extends UserTemplatePage {

    static final Log           LOG                    = LogFactory.getLog(AttributeAddPage.class);
    ...
    public AttributeAddPage() {
        ...
        getContent().add(new ListView<AttributeDO>(ATTRIBUTES_ID, attributeList) {
            ...
            protected void populateItem(final ListItem<AttributeDO> attributeItem) {
                ...
                attributeItem.add(new PageLink<String>(EDIT_LINK_ID, AttributeAddPage.class).setVisible(attribute.isEditable()));
                attributeItem.add(new PageLink<String>(ADD_LINK_ID, AttributeAddPage.class).setVisible(attribute.isEditable()
                ...
                attributeItem.add(new Link<String>(REMOVE_LINK_ID) {
                    ...
                    public void onClick() {
                        ...
                        setResponsePage(AttributeAddPage.class);
