...
public class MainPage extends UserTemplatePage {
    ...
    private OlasLogoutLink     logoutLink;
    ...
    public MainPage() {
        ...
        logoutLink = new OlasLogoutLink(SidebarBorder.LINK_ID, MainPage.class);
        loginLink = new OlasLoginLink(SidebarBorder.LINK_ID, OverviewPage.class) {
        ...
        getSidebar(localize("helpMain"), false);
        getContent().add(
    ...
    protected void onBeforeRender() {
        ...
        if (OLASSession.get().isUserSet()) {
            getSidebar().setLinks(new SideLink(logoutLink, localize("logout")));
        } else {
            getSidebar().setLinks(new SideLink(loginLink, localize("loginaction")));
        }
