...
public interface AgentServiceMBean extends Agent {
     ...
     */
    public void deploy() throws JMException, NamingException, MalformedURLException, IOException;
    ...
    /**
     * Called by JBoss when this service has been fully deployed and initialised.
     */
    public void start();
