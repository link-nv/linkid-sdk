...
abstract class SAML2_Binding {
    ...
    /*
     * Optional extra request parameters for the destination of messages. 
     * This can be NULL.
     */
    protected $destinationParams;
    ...
    public function setDestinationParams($destinationParams) {

        assert('is_string($destinationParams) || is_null($destinationParams)');
