 ...
 * @author mbillemo
 */
public class ScenarioChooser extends JPanel implements ActionListener, CaretListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (this.browseButton.equals( e.getSource() )) {
            ...
            new ScenarioUploaderThread( getSelectedAgents(), this, getScenarioFile() ).run();
            ...
            new ScenarioExecutorThread( getSelectedAgents(), this, this.consoleData ).run();
    ...
    private Map<Address, Agent> getSelectedAgents() {
        ...
        for (Map.Entry<Address, Agent> agentEntry : this.consoleData.getAgents().entrySet())
