...
public class ScenarioChooser extends JPanel implements ActionListener,
	...
	public ScenarioChooser() {
		...
		this.actionButtons = new JPanel(new GridLayout(1, 0, 10, 5));
		this.actionButtons.add(this.uploadButton);
		this.actionButtons.add(this.deployButton);
		this.actionButtons.add(this.executeButton);
		this.actionButtons.add(this.chartsButton);
