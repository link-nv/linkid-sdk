...
public class ScenarioChooser extends JPanel implements ActionListener,
	...
	public ScenarioChooser() {
		...
		FormLayout buttonLayout = new FormLayout(
				"p:g, 4dlu, p:g, 4dlu, p:g, 4dlu, p:g");
		DefaultFormBuilder buttonBuilder = new DefaultFormBuilder(buttonLayout);
		this.actionButtons = buttonBuilder.getPanel();
		buttonBuilder.append(this.uploadButton);
		buttonBuilder.append(this.deployButton);
		buttonBuilder.append(this.executeButton);
		buttonBuilder.append(this.chartsButton);
		buttonBuilder.append(this.refreshButton, 3);
		buttonBuilder.append(this.resetButton, 3);
