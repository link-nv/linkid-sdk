...
public class ScenarioChooser extends JPanel implements ActionListener, CaretListener, AgentSelectionListener, ExecutionSelectionListener,
    ...
    public ScenarioChooser() {
        ...
        this.scenarioField.setToolTipText("The EAR package that contains the scenario that must be uploaded to and executed by the agent.");
        ...
        this.deployButton.setToolTipText("Instruct the selected agents to deploy the last scenario that was uploaded to them.");
        this.executeButton.setToolTipText("Execute the scenario on the selected agents for the given duration on the given OLAS host.");
        this.chartsButton
                         .setToolTipText("Display the charts generated by the selected agents from their previously completed profiling run.");
        this.pdfButton.setToolTipText("Create, save and open a PDF file generated from the statistics collected by the selected agents.");
    ...
    private void updateButtons() {
        ...
        if (ConsoleData.getSelectedAgents().isEmpty()) {
            ...
            buttonToggler(false, this.refreshButton, this.resetButton, this.uploadButton, this.deployButton, this.executeButton,
        ...
        for (ConsoleAgent agent : ConsoleData.getSelectedAgents()) {
            ...
            if (agent.isTransitting()) {
                ...
                buttonToggler(false, this.uploadButton, this.deployButton, this.executeButton, this.chartsButton, this.pdfButton);
            }
