...
public class SwingConsole {
    ...
    private void initExceptionDialog() {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(Thread t, Throwable e) {
                ...
                JDialog dialog = new JDialog((Frame) null, "Uncaught exception: " + e.getMessage());
    ...
    private void buildUI() {
        ...
        FormLayout layout = new FormLayout("0dlu:g, 5dlu, p, 5dlu, p, 5dlu, p, 5dlu, p",
        ...
        builder.appendSeparator("Group " + ConsoleData.getAgentDiscoverer().getGroupName());
        builder.nextRow();

        JScrollPane agentsListPane = new JScrollPane(agentsList);
        JScrollPane executionInfoPane = new JScrollPane(executionInfo, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
                ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        executionInfoPane.getViewport().setBackground(executionInfo.getBackground());
        agentsListPane.getViewport().setBackground(agentsList.getBackground());
        final JSplitPane split = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, agentsListPane, executionInfoPane);
        ...
        // Frame.
        final JFrame frame = new JFrame("SafeOnline Performance Testing Console");
