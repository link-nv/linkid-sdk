...
public abstract class LinkIDApplicationPage extends WicketPage {
    ...
    private static final Log LOG = LogFactory.getLog( LinkIDApplicationPage.class );

    public LinkIDApplicationPage() {

        super();
    }

    public LinkIDApplicationPage(PageParameters parameters) {
     ...
     *
     * <p>
     * Called by {@link LinkIDApplicationPage} after successfully logging in with linkID.<br>
