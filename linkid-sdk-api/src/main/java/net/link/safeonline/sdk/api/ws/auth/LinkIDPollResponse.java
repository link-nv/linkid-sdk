 ...
 * Time: 13:37
 */
public class LinkIDPollResponse<Response> implements Serializable {
    ...
    public LinkIDPollResponse(final LinkIDAuthenticationState linkIDAuthenticationState, final LinkIDPaymentState paymentState, final String paymentMenuURL,
