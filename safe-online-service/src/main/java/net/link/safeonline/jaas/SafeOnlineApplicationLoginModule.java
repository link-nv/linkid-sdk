...
public class SafeOnlineApplicationLoginModule implements LoginModule {
    ...
    public static final String DEFAULT_AUTHENTICATION_SERVICE_JNDI_NAME = ApplicationAuthenticationService.JNDI_BINDING;
    ...
    public boolean commit()
        ...
        rolesGroup.addMember(new SimplePrincipal(SafeOnlineApplicationRoles.APPLICATION_ROLE));
    ...
    public boolean login()
        ...
        PasswordCallback passwordCallback = new PasswordCallback("X509 application certificate in Hex", false);
    ...
    private ApplicationAuthenticationService getApplicationAuthenticationService()
        ...
        try {
            ApplicationAuthenticationService applicationAuthenticationService = EjbUtils.getEJB(authenticationServiceJndiName,
