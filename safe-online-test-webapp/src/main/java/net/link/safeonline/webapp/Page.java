...
public abstract class Page {
    ...
    public static void setAcceptanceManager(AcceptanceTestManager acceptanceTestManager) {
    ...
    public void logout() {
        ...
        Assert.assertTrue(selenium.isElementPresent("xpath=//a[contains(@id, 'login')]")
                || selenium.isElementPresent("xpath=//input[contains(@id, 'login')]"));
    }
    ...
    protected void clickTab(String id) {
        ...
        selenium.click("xpath=//input[@type = 'hidden' and contains(@value, '" + id + "']");
    }

    protected void clickButton(String id) {

        selenium.click("xpath=//input[@type = 'submit' and contains(@id, '" + id + "')]");
    }
    ...
    protected boolean isCheckedRadioButton(String value) {
        ...
        return selenium.isChecked("xpath=//input[@type = 'radio' and contains(@value, '" + value + "')]");
    }

    protected boolean isCheckedCheckBox(String id) {

        return selenium.isChecked("xpath=//input[@type = 'checkbox' and contains(@Id, '" + id + "')]");
    }

    protected void clickRadioButton(String value) {

        selenium.click("xpath=//input[@type = 'radio' and contains(@value, '" + value + "')]");
    }

    protected void clickCheckbox(String id) {

        selenium.click("xpath=//input[@type = 'checkbox' and contains(@Id, '" + id + "')]");
    }
    ...
    protected boolean checkLinkInRow(String table, String row, String id) {
        ...
        return selenium.isVisible("xpath=//table[contains(@Id, '" + table + "')]//tr[./td[contains(text(), '" + row
                + "')]]/td/a[contains(@Id, '" + id + "')]");
    }
