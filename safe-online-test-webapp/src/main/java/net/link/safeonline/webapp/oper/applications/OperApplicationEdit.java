...
public class OperApplicationEdit extends OperTemplate {
    ...
    public static final String PAGE_NAME = SAFE_ONLINE_OPER_WEBAPP_PREFIX + "/applications/application-edit.seam";
    ...
    public void setAttribute(String name, boolean included, boolean required, boolean datamining) {
