...
import net.link.safeonline.beid.Registration;
...
public class DisableBean implements Disable {
    ...
    private static final String  REGISTRATIONS_LIST_NAME = "registrations";
    ...
    public List<Registration> registrationsFactory() throws SubjectNotFoundException, DeviceNotFoundException {
    ...
    private List<Registration> listRegistrations(String deviceId, Locale locale) throws DeviceNotFoundException,
    ...
    private List<Registration> listRegistrations(SubjectEntity subject, DeviceEntity device, Locale locale) {

        List<Registration> deviceRegistrations = new LinkedList<Registration>();
        ...
        for (AttributeEntity attribute : attributes) {
            ...
            deviceRegistrations.add(new Registration(device, attributeView, disableAttribute.getBooleanValue(),
                    attribute.getAttributeIndex()));
        }
