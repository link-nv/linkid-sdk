...
public interface LinkIDConfig {
     ...
     * </p>
     */
    @Config.Property(required = true, unset = "/entry")
    String authPath();
     ...
     *
     * <p>
     * We go here after linkID-auth asked us to clean our session up following a logout request that was initiated from another application
     * in our application's SSO pool.  This response allows linkID to find out whether we successfully logged the user out of the application's SSO session.
     * </p>
     */
     ...
     *
     * <p>
     * Accepted values are names of themes configured by the operator of the linkID node you'll be using.
     * </p>
     */
