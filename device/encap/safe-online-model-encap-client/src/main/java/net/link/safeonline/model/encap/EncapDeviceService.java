...
public interface EncapDeviceService extends EncapService {
	...
	public static final String JNDI_BINDING = EncapService.JNDI_PREFIX
			+ "EncapDeviceServiceBean/local";
	 ...
	 */
	String authenticate(String mobileOTP) throws SubjectNotFoundException,
			DeviceDisabledException, DeviceRegistrationNotFoundException,
			MobileException, DeviceAuthenticationException;
	 ...
	 */
	String register(String mobile) throws MobileException,
			DeviceRegistrationException;

	/**
	 * Commits the encap registration for OLAS, creates a device subject if
	 * necessary, creates a new device registration for this mobile and attaches
	 * it to the device subject.
	 * 
	 * @param nodeName
	 * @param userId
	 * @param mobile
	...
	void commitRegistration(String nodeName, String userId, String otp)
			throws MobileException, DeviceAuthenticationException,
			NodeNotFoundException, AttributeTypeNotFoundException,
	 ...
	 * 
	 */
	void remove(String userId, String id) throws SubjectNotFoundException,
	 ...
	 * @param mobile
	 */
	void requestOTP(String mobile) throws MobileException;
	 ...
	 * @throws SubjectNotFoundException
	 */
	void disable(String userId, String id) throws SubjectNotFoundException,
	 ...
	 * @throws MobileException
	 */
	void enable(String userId, String otp) throws SubjectNotFoundException,
			DeviceRegistrationNotFoundException, MobileException,
			DeviceAuthenticationException;

	/**
	 * @return <code>true</code> when an OTP has been dispatched to the user and
	 *         we're waiting to verify it.
	 */
