package test.unit.net.link.safeonline.model.digipass;
...
public class DigipassDeviceTest {

    private DigipassDeviceServiceBean testedInstance;
    ...
    private String                    testInvalidToken;
