...
/**
 * <h2>{@link DeviceOperationExitServlet}<br>
 ...
 * @author lhunath
 */
public class DeviceOperationExitServlet extends AbstractDeviceOperationExitServlet {

    private static final long serialVersionUID = 1L;
    private static final Log  LOG              = LogFactory.getLog(DeviceOperationExitServlet.class);
