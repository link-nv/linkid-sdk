...
public class IntegrationTestUtils {
	...
	public static ProxyAttributeService getProxyAttributeService(
			InitialContext initialContext) {
		ProxyAttributeService proxyAttributeService = EjbUtils.getEJB(
				initialContext, "SafeOnline/ProxyAttributeServiceBean/remote",
	...
	public static PasswordDeviceService getPasswordDeviceService(
			InitialContext initialContext) {
		PasswordDeviceService passwordDeviceService = EjbUtils.getEJB(
				initialContext, "SafeOnline/PasswordDeviceServiceBean/remote",
