...
public class SafeOnlineTestContainer {
    ...
    public static final Class<?>[] sessionBeans = new Class[] { SubjectDAOBean.class, ApplicationDAOBean.class, SubscriptionDAOBean.class,
            ...
            IdGeneratorBean.class, UsageAgreementDAOBean.class, UsageAgreementManagerBean.class, SecurityAuditLoggerBean.class,
            DevicePolicyServiceBean.class, DevicesBean.class, AccountServiceBean.class, NodeDAOBean.class, NodeMappingServiceBean.class,
