...
public class SafeOnlineTestContainer {
    ...
    public static final Class<?>[] sessionBeans = new Class[] { SubjectDAOBean.class, ApplicationDAOBean.class,
            SubscriptionDAOBean.class, AttributeDAOBean.class, TrustDomainDAOBean.class, ApplicationOwnerDAOBean.class,
            AttributeTypeDAOBean.class, ApplicationIdentityDAOBean.class, SubjectManagerBean.class,
            HistoryDAOBean.class, ApplicationOwnerManagerBean.class, ApplicationIdentityManagerBean.class,
            ConfigGroupDAOBean.class, ConfigItemDAOBean.class, TaskDAOBean.class, SchedulingDAOBean.class,
            TaskHistoryDAOBean.class, ApplicationManagerBean.class, TrustPointDAOBean.class,
            CachedOcspResponseDAOBean.class, AttributeTypeDescriptionDecoratorBean.class,
            AttributeProviderDAOBean.class, ApplicationsBean.class, DeviceDAOBean.class, DeviceClassDAOBean.class,
            AllowedDeviceDAOBean.class, HelpdeskContextDAOBean.class, HelpdeskEventDAOBean.class,
            CredentialManagerBean.class, PkiProviderManagerBean.class, PkiValidatorBean.class,
            CachedOcspValidatorBean.class, OcspValidatorBean.class, SubjectIdentifierDAOBean.class,
            UserRegistrationManagerBean.class, ResourceAuditLoggerBean.class, AuditAuditDAOBean.class,
    ...
    public static final Class<?>[] entities     = new Class[] { SubjectEntity.class, ApplicationEntity.class,
            ...
            TrustDomainEntity.class, ApplicationIdentityEntity.class, ConfigGroupEntity.class, ConfigItemEntity.class,
            TaskEntity.class, SchedulingEntity.class, TaskHistoryEntity.class,
