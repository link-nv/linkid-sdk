...
public interface SubjectService {
    ...
    /**
     * Adds a 'device subject'. This is used by external device issuers. The userId matches the device mapping ID
     * returned by OLAS. Does NOT create a login attribute nor add a login-userId identifier mapping.
     * 
     * @param userId
     * @return the subject.
     */
    ...
    /**
     * Adds a device registration subject. This subject represent a specific device registration. This is used by
     * external device issuers. No login attribute nor identifier mapping will be created.
     * 
     * @return
     */
    ...
    /**
     * Finds the device subject for a given user ID. Returns <code>null</code> if the entity could not be found. This is
     * used by external device issuers.
     * 
     * @param deviceUserId
     * @return the subject or <code>null</code> if the subject was not found.
     */
     ...
     * 
     */
    DeviceSubjectEntity getDeviceSubject(SubjectEntity deviceRegistration) throws SubjectNotFoundException;
     ...
     * @exception SubjectNotFoundException
     */
    DeviceSubjectEntity getDeviceSubject(String deviceUserId) throws SubjectNotFoundException;
