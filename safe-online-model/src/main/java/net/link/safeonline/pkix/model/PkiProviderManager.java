...
public interface PkiProviderManager extends SafeOnlineService {
     ...
     * that could handle the certificate's validation process, this method returns <code>null</code>.
     * 
     * @param certificate
     * @return the PKI provider, or <code>null</code> if no existing PKI provider could handle the certificate's validation.
     */
