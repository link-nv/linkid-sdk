...
/**
 * Subject Context. In a J2EE application the subject context will most likely
 * map to an EJB session bean context. This means that this subject context will
 * use the J2EE security, transaction and naming context of the calling session
 * bean. The easiest way to construct the subject context is to let the calling
