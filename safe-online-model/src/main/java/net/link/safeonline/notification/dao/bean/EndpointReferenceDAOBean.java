...
public class EndpointReferenceDAOBean implements EndpointReferenceDAO {
	...
	public EndpointReferenceEntity findEndpointReference(String address,
			ApplicationEntity application) {
		LOG.debug("find endpoint ref: address=" + address + " application="
				+ application.getName());
	...
	public EndpointReferenceEntity findEndpointReference(String address,
			DeviceEntity device) {
		LOG.debug("find endpoint ref: address=" + address + " device="
				+ device.getName());
	...
	public void remove(EndpointReferenceEntity endpoint) {
		LOG.debug("remove endpoint: " + endpoint.getAddress() + ", "
				+ endpoint.getName());
		// Manage relationships.
		List<NotificationProducerSubscriptionEntity> topics = this.notificationProducerDAO
				.listTopics();
