...
public interface DeviceSubjectDAO {
     ...
     */
    DeviceSubjectEntity getSubject(String userId) throws SubjectNotFoundException;
     ...
     * @exception SubjectNotFoundException
     */
    DeviceSubjectEntity getSubject(SubjectEntity deviceRegistration) throws SubjectNotFoundException;
}
