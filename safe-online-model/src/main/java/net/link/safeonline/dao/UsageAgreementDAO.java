...
public interface UsageAgreementDAO {
    ...
    List<UsageAgreementTextEntity> listUsageAgreementTexts(ApplicationEntity application, Long usageAgreementVersion);

    UsageAgreementTextEntity addUsageAgreementText(UsageAgreementEntity usageAgreement, String text, String language);
    ...
    UsageAgreementTextEntity getGlobalUsageAgreementText(GlobalUsageAgreementEntity usageAgreement, String language);

    void removeGlobalUsageAgreementText(UsageAgreementTextEntity usageAgreementText);
}
