...
public interface UsageAgreementService {
     ...
     * @throws ApplicationNotFoundException
     */
    UsageAgreementEntity getCurrentUsageAgreement(String applicationName) throws PermissionDeniedException,
     ...
     * @throws PermissionDeniedException
     */
    UsageAgreementEntity getDraftUsageAgreement(String applicationName) throws ApplicationNotFoundException,
     ...
     * @throws PermissionDeniedException
     */
    List<UsageAgreementEntity> getUsageAgreements(String applicationName) throws ApplicationNotFoundException,
            PermissionDeniedException;
     ...
     * @throws PermissionDeniedException
     */
    void removeDraftUsageAgreement(String applicationName) throws ApplicationNotFoundException,
            PermissionDeniedException;
     ...
     * @throws SubscriptionNotFoundException
     */
    void confirmUsageAgreementVersion(String applicationName) throws ApplicationNotFoundException,
