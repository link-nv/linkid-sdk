 ...
 * 
 * <p>
 * Applications can only retrieve attributes for which the user did confirm the
 * corresponding application identity. Application also cannot retrieve
 * attributes that are marked as data-mining attribute types.
 * </p>
 * 
 * @author fcorneli
 * 
...
public interface AttributeService {
	 ...
	 * access the attribute value. The attribute should not be marked as
	 * data-mining attribute type.
	 * 
	 * <p>
	 * The returned object can be a {@link String} or {@link Boolean}, ...
	 * depending on the actual datatype used by corresponding attribute type of
	 * the requested attribute. In case of a multivalued attribute the returned
	 ...
	 * 
	 * <p>
	 * It is possible that a user already confirmed an attribute usage over an
	 * attribute that he still needs to define. In this case the resulting map
	 * will not contain an entry for the missing attribute.
	 * </p>
	 * 
	 * <p>
	 * The type of map values depends on the actual datatype used by the
