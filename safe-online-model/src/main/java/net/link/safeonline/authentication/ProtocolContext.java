...
/**
 * Protocol Context class. Protocol Context objects should be generated by protocol handlers after they have
 * successfully processed an authentication request.
 * 
 * @author fcorneli
 * 
 */
public class ProtocolContext {
     ...
     * 
     * @param applicationId
     *            the application Id of the application that the authentication protocol handler has determined that
     *            issued the authentication request.
     * @param applicationFriendlyName
     *            the application friendly name, can be used by the remote device issuer to display what the user is
     *            authenticating for
     * @param target
