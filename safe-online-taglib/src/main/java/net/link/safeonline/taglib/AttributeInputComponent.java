...
public class AttributeInputComponent extends UIInput {
    ...
    private static void registerRenderer(Class<? extends Renderer> clazz) {
        ...
        try {
            ...
            throw new RuntimeException("instantiation error for class: " + clazz.getName());
        }
    }
    ...
    public static class StringRenderer implements Renderer {
        ...
        public void encodeBegin(FacesContext context, UIInput inputComponent) throws IOException {
            ...
            try {
                ...
                responseWriter.writeAttribute("class", attributeInputComponent.getTextStyleClass(), "textStyleClass");
            } catch (Exception e) {
                // empty
            }
    ...
    public static class BooleanRenderer implements Renderer {
        ...
        public void encodeBegin(FacesContext context, UIInput inputComponent) throws IOException {
            ...
            String falseId = clientId + NamingContainer.SEPARATOR_CHAR + "false";
            ...
            if (needToAddInlineScript(context)) {
                ...
                LOG.debug("addResource class: " + addResource.getClass().getName());
                String inlineScript = getInlineScript();
                addResource.addInlineScriptAtPosition(context, AddResource.HEADER_BEGIN, inlineScript);
            }
        }
        ...
        private String getInlineScript() {
            ...
            stringBuffer.append("    function threeValuedCheckboxClicked(checked, form, checkboxId) {\n");
            stringBuffer.append("        if (true == checked) {\n");
            stringBuffer.append("            form.elements[checkboxId].checked = false;\n");
            stringBuffer.append("         }\n");
            stringBuffer.append("    }\n");
