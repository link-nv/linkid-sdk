...
public class AttributeDescriptionBean implements AttributeDescription {
	...
	@Begin
	public String edit() {
		LOG.debug("edit attribute type description: "
				+ this.selectedAttributeTypeDescription.getLanguage());
		return "edit";
	}
	...
	public AttributeTypeDescriptionEntity newAttributeTypeDescriptionFactory() {
		...
		return newAttributeTypeDescription;
	}
	...
	public String save() {
		...
		this.attributeTypeService
				.saveDescription(this.selectedAttributeTypeDescription);
		return "saved";
	}
