...
public abstract class AbstractInjectionServlet extends HttpServlet {
     ...
     * default hostbase is configured in the {@link WebConfig} file (see
     * {@link ConfigUtils#getApplicationURL()}). If the base URI for your web application is different than
