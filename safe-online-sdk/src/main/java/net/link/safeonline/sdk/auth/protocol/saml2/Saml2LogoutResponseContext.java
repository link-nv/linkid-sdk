 ...
 */
public class Saml2LogoutResponseContext {

    private final LogoutResponse   response;
    private final CertificateChain certificateChain;

    public Saml2LogoutResponseContext(final LogoutResponse response, final CertificateChain certificateChain) {
    ...
    /**
     * @return the SAML v2.0 logout response
     */
