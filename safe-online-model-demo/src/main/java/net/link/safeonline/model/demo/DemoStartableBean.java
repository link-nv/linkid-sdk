...
@LocalBinding(jndiBinding = DemoConstants.DEMO_STARTABLE_JNDI_PREFIX
		+ "DemoStartableBean")
public class DemoStartableBean extends AbstractInitBean {
	...
	public DemoStartableBean() {
		...
		this.hostport = Integer
				.parseInt(properties.getString("olas.host.port"));
		this.hostportssl = Integer.parseInt(properties
				.getString("olas.host.port.ssl"));
		this.demoAppWebappName = properties
				.getString("olas.demo.app.webapp.name");
		this.demoTicketWebappName = properties
				.getString("olas.demo.ticket.webapp.name");
		this.demoPaymentWebappName = properties
				.getString("olas.demo.payment.webapp.name");
		this.demoLawyerWebappName = properties
				.getString("olas.demo.lawyer.webapp.name");
		this.demoPrescriptionWebappName = properties
				.getString("olas.demo.prescription.webapp.name");
		this.demoMandateWebappName = properties
				.getString("olas.demo.mandate.webapp.name");
		this.demoCinemaWebappName = properties
		...
		try {
			this.registeredApplications.add(new Application(
					DEMO_APPLICATION_NAME, "owner", null, new URL(
							this.protocol, this.hostname, this.hostport, "/"
									+ this.demoAppWebappName), getLogo(), null,
	...
	private void configMandateDemo() {
		...
		try {
			this.registeredApplications.add(new Application(
					DEMO_MANDATE_APPLICATION_NAME, "owner", null, new URL(
							this.protocol, this.hostname, this.hostport, "/"
									+ this.demoMandateWebappName), getLogo(),
		...
		this.subscriptions.add(new Subscription(SubscriptionOwnerType.SUBJECT,
				"mbillemo", DEMO_MANDATE_APPLICATION_NAME));
	...
	private void configTicketDemo() {
		...
		try {
			this.registeredApplications.add(new Application(
					DEMO_TICKET_APPLICATION_NAME, "owner", null, new URL(
							this.protocol, this.hostname, this.hostport, "/"
									+ this.demoTicketWebappName),
					getLogo("/eticket-small.png"), null, true, true,
					demoTicketCertificate, false, IdScopeType.SUBSCRIPTION));
		} catch (MalformedURLException e) {
			throw new EJBException("Malformed URL Exception: " + e.getMessage());
		}
	...
	private void configCinemaDemo() {
		...
		try {
			this.registeredApplications.add(new Application(
					DEMO_CINEMA_APPLICATION_NAME, "owner", null, new URL(
							this.protocol, this.hostname, this.hostport, "/"
									+ this.demoCinemaWebappName),
	...
	private void configPaymentDemo() {
		...
		try {
			this.registeredApplications.add(new Application(
					DEMO_PAYMENT_APPLICATION_NAME, "owner", null, new URL(
							this.protocol, this.hostname, this.hostport, "/"
									+ this.demoPaymentWebappName),
					getLogo("/ebank-small.png"), null, true, true,
		...
		this.subscriptions.add(new Subscription(SubscriptionOwnerType.SUBJECT,
				"mbillemo", DEMO_PAYMENT_APPLICATION_NAME));
	...
	private void configPrescriptionDemo() {
		...
		try {
			this.registeredApplications.add(new Application(
					DEMO_PRESCRIPTION_APPLICATION_NAME, "owner", null, new URL(
							this.protocol, this.hostname, this.hostport, "/"
									+ this.demoPrescriptionWebappName),
					getLogo(), null, true, true, demoPrescriptionCertificate,
					true, IdScopeType.SUBSCRIPTION));
		} catch (MalformedURLException e) {
			throw new EJBException("Malformed URL Exception: " + e.getMessage());
		}
		...
		this.subscriptions.add(new Subscription(SubscriptionOwnerType.SUBJECT,
				"mbillemo", DEMO_PRESCRIPTION_APPLICATION_NAME));
	...
	private void configLawyerDemo() {
		...
		try {
			this.registeredApplications.add(new Application(
					DEMO_LAWYER_APPLICATION_NAME, "owner", null, new URL(
							this.protocol, this.hostname, this.hostport, "/"
									+ this.demoLawyerWebappName), getLogo(),
		...
		this.subscriptions.add(new Subscription(SubscriptionOwnerType.SUBJECT,
				"mbillemo", DEMO_LAWYER_APPLICATION_NAME));
	...
	private void configDemoUsers() {
		...
		this.subscriptions.add(new Subscription(SubscriptionOwnerType.SUBJECT,
				"mbillemo", DEMO_APPLICATION_NAME));
		this.subscriptions.add(new Subscription(SubscriptionOwnerType.SUBJECT,
				"mbillemo", DEMO_TICKET_APPLICATION_NAME));
		this.subscriptions.add(new Subscription(SubscriptionOwnerType.SUBJECT,
				"mbillemo", DEMO_PAYMENT_APPLICATION_NAME));
		this.subscriptions.add(new Subscription(
	...
	private void configureNode() {
		...
		this.node = new Node(this.nodeName, this.sslProtocol, this.hostname,
				this.hostport, this.hostportssl, authIdentityServiceClient
						.getCertificate(), identityServiceClient
						.getCertificate());
