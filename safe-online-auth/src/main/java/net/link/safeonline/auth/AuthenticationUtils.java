...
public class AuthenticationUtils {
     ...
     * <p>
     * The method requires the <code>DeviceAuthenticationServiceUrl</code> init parameter defined in web.xml pointing to
     ...
     * @param username
     */
    public static String redirect(String landingUrl, String device, String username) {
        ...
        try {
            encodedSamlRequestToken = authenticationService.redirectRegistration(registrationServiceUrl,
                    encodedLandingUrl, device, username);
