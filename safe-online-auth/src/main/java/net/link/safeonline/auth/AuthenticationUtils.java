...
public class AuthenticationUtils {
    ...
    /**
     * Redirects the authentication webapp to the external device landing page using the SAML browser post protocol. The
     * SAML authentication request is generated by the authentication service associated with this HTPP session.
     * <p>
     * The method requires the <code>DeviceAuthenticationServiceUrl</code> init parameter defined in web.xml pointing
     * to the location of the authentication web application location the Device issuer should return to.
     * </p>
     * <p>
     * An optional initialization parameter <code>Saml2BrowserPostTemplate</code> can be defnied in web.xml,
    ...
    public static String redirectAuthentication(String landingUrl, String device) {
        ...
        try {
            encodedSamlRequestToken = authenticationService.redirectAuthentication(authenticationServiceUrl,
         ...
         * (such as an HTTP redirect), and that the request processing lifecycle should be terminated as soon as the
    ...
    /**
     * Redirects the authentication to the external device registration landing page using the SAML browser post
     * protocol. The SAML authentication request is generated by the authentication service associated with this HTPP
     * session.
     * <p>
     * The method requires the <code>DeviceRegistrationServiceUrl</code> init parameter defined in web.xml pointing to
     * the location of the authentication web application location the device issuer should return to.
     * </p>
     * <p>
     * An optional initialization parameter <code>Saml2BrowserPostTemplate</code> can be defnied in web.xml,
     * specifying a custom SAML2 browser post velocity template.
    ...
    public static String redirect(String landingUrl, String device, String userId) {
        ...
        String encodedSamlRequestToken;
        try {
            encodedSamlRequestToken = authenticationService.redirectRegistration(registrationServiceUrl,
                    encodedLandingUrl, device, userId);
