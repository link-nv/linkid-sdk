...
public class CertPathApiTest {
    ...
    public void validating()
        ...
        X509Certificate rootCaCert = PkiTestUtils.generateSelfSignedCertificate(rootCaKeyPair, "CN=RootCA");
        ...
        LOG.debug("cert path validator provider: " + certPathValidator.getProvider().getName());
        ...
        PKIXBuilderParameters certPathParams = new PKIXBuilderParameters(trustAnchors, certSelector);
        certPathParams.setRevocationEnabled(false);
        CertPathBuilder certPathBuilder = CertPathBuilder.getInstance("PKIX");
        LOG.debug("cert path builder provider: " + certPathBuilder.getProvider().getName());
        CertPathBuilderResult certPathBuilderResult = certPathBuilder.build(certPathParams);
        ...
        LOG.debug("result trust anchor: " + result.getTrustAnchor().getTrustedCert());
    }
}
