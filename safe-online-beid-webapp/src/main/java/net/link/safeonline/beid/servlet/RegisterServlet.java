...
public class RegisterServlet extends HttpServlet {
	...
	private void prepareJavaVersionCheck(HttpServletRequest req,
		...
		JavaVersionServlet.setJava15Target("register-beid.seam", session);
		JavaVersionServlet.setJava16Target("register-beid.seam", session);
		LOG
				.debug("redirecting to beid.html for Java runtime version checking...l");
