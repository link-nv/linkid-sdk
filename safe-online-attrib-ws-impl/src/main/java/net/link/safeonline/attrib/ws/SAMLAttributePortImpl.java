...
public class SAMLAttributePortImpl implements SAMLAttributePort {
    ...
    public ResponseType attributeQuery(AttributeQueryType request) {
        ...
        if (null == subjectLogin) {
            ...
            ResponseType errorResponse = createRequesterErrorResponse(null, "no subject found");
        ...
        AssertionType assertion = getAttributeAssertion(subjectLogin, attributeMap);
    ...
    private ResponseType createRequestDeniedResponse() {
        ...
        ResponseType response = createRequesterErrorResponse(SamlpSecondLevelErrorCode.REQUEST_DENIED, null);
        return response;
    }
    ...
    private ResponseType createRequesterErrorResponse(SamlpSecondLevelErrorCode secondLevelStatusCode, String statusMessage) {
        ...
        if (null != secondLevelStatusCode) {
            ...
            jaxbSecondLevelStatusCode.setValue(secondLevelStatusCode.getErrorCode());
            response.getStatus().getStatusCode().setStatusCode(jaxbSecondLevelStatusCode);
        }
    ...
    private AssertionType getAttributeAssertion(String subjectLogin, Map<String, Object> attributes) {
        ...
        for (Map.Entry<String, Object> attribute : attributes.entrySet()) {
            ...
            if (null != attributeValue && attributeValue.getClass().isArray()) {
                ...
                /*
                 * Via the "multivalued" XML attribute we communicate the type to the client.
                 */
                Map<QName, String> otherAttributes = statementAttribute.getOtherAttributes();
                ...
                for (Object item : array) {
                    if (item instanceof Map) {
                        ...
                        for (Map.Entry<String, Object> compoundedAttributeValue : compoundedAttributeValues.entrySet()) {
                            ...
                            memberAttribute.setName(compoundedAttributeValue.getKey());
                            memberAttribute.getAttributeValue().add(compoundedAttributeValue.getValue());
                            compoundedAttribute.getAttributeValue().add(memberAttribute);
                        }
